...
from src.pointnet2.pointnet2_utils import PointNetSetAbstraction, PointNetSetAbstractionMsg
...
class Pointnet2_Ssg(nn.Module):
    def __init__(self, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=512, radius=0.2, nsample=32, in_channel=in_channel, mlp=[64, 64, 128], group_all=False) #对点云进行抽样，提取不同层次的特征
        ...
        self.drop1 = nn.Dropout(0.4) # 一定概率将一些神经元的输出值为0，增加泛化性，降低过拟合
