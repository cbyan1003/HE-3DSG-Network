...
def process(pth_scan, scan_id, label_type, verbose=False) -> list:
    ...
    pth_pd  = os.path.join(define.SCANNET_DATA_PATH,scan_id,args.scan_name) # inseg.ply
    pth_ply = os.path.join(define.SCANNET_DATA_PATH,scan_id,scan_id+define.SCANNET_PLY_SUBFIX) #_vh_clean_2.labels.ply
    pth_agg = os.path.join(define.SCANNET_DATA_PATH,scan_id,scan_id+define.SCANNET_AGGRE_SUBFIX) #.aggregation.json
    pth_seg = os.path.join(define.SCANNET_DATA_PATH,scan_id,scan_id+define.SCANNET_SEG_SUBFIX) #_vh_clean_2.0.010000.segs.json
